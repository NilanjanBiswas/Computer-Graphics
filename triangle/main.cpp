...
void lightSetting()
{
    ...
    glLightfv(GL_LIGHT1, GL_AMBIENT, ambientIntensity); // 7. ambient property adding to Light0
    glLightfv(GL_LIGHT1, GL_DIFFUSE, diffuseIntensity); // 9. ambient property adding to Light0
    glLightfv(GL_LIGHT1, GL_POSITION, position); // 11. position property adding to Light0
}
