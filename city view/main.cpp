  ...
  case 'r':  ///red
    ...
    _speed_car_3 = 0.0020f;
     ...
     case 's':  ///car slow
          ...
          P=0;
    _move_car_1 = saveCar1;
    _speed_car_1 = 0.0005f;

    _move_car_2 = saveCar2;
    _speed_car_2 = 0.0005f;
    _move_car_3 = saveCar3;
    _speed_car_3 = 0.0005f;
...
void sound()
{
    ...
    //PlaySound(TEXT("train-pass-by-01.wav") NULL,SND_ASYNC|SND_FILENAME|SND_LOOP);
     //sndPlaySound(TEXT("train-pass-by-01.wav"),SND_ASYNC);
